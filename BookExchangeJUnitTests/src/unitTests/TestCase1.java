...
public class TestCase1 {
  ...
  public void setUp() throws Exception {
	System.setProperty("webdriver.gecko.driver", "C:\\Users\\Nick\\SchoolSpace\\BookExchangeJUnitTests\\webdrivers\\geckodriver.exe");
  ...
  @Test
  public void AcreateNewUser1() throws Exception {
  ...
  @Test
  public void BnewUserAddBook2() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("newUser");
  ...
  @Test
  public void CnewUserViewMyBooks3() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("newUser");
  ...
  @Test
  public void DnewUserMakeTrade4() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("newUser");
  ...
  @Test
  public void EshannonNotificationsAcceptJsteinTrade5() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
  ...
  @Test
  public void FjsteinNotificationsOkShannonMsg6() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
  ...
  @Test
  public void GshannonNotificationsDeclineNewUserTrade7() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("shannon");
  ...
  @Test
  public void HnewUserNotificationsOkShannonMsg8() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("newUser");
  ...
  @Test
  public void InewUserHomePurchase9() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("newUser");
  ...
  @Test
  public void JshannonNotificationsOkNewUserMsg10() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("shannon");
  ...
  @Test
  public void KnewUserNotificationsOkPurchaseMsg11() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("newUser");
  ...
  @Test
  public void LnewUserAddBookUnavailable12() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("newUser");
  ...
  @Test
  public void MnewUserMyBooksHomeUnavailableBookNotThere13() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("newUser");
  ...
  @Test
  public void NnewUserContactUsMessage14() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
    driver.findElement(By.name("username")).sendKeys("newUser");
  ...
  @Test
  public void OadminNotificationsOkMsg15() throws Exception {
    driver.get(baseUrl + "/BookExchange/Login");
	Thread.sleep(5000);
    driver.findElement(By.name("username")).clear();
