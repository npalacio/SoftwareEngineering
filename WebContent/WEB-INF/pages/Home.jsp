...
<body>
 ...
 -->
	...
	<jsp:useBean id="exampleBook" class="models.Book" scope="page">
   		...
   		<jsp:setProperty name="exampleBook" property="publisher" value="Publisher" />
	...
	<jsp:useBean id="exampleBook2" class="models.Book" scope="page">
   		...
   		<jsp:setProperty name="exampleBook2" property="publisher" value="Publisher2" />
   		<jsp:setProperty name="exampleBook2" property="date" value="Date2" />
   		<jsp:setProperty name="exampleBook2" property="ISBN" value="1234567892" />
	</jsp:useBean>
